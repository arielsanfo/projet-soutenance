...
class AppColors {
  static const Color primaryColor = Color(0xFF6C63FF); // Violet principal (Dribbble-like)
  static const Color primaryDarker = Color(0xFF574FD8); // Variante plus foncée pour :hover
  static const Color primaryLight = Color(0xFFE8EAF3); // Variante claire pour fonds secondaires ou boutons

  static const Color secondaryColor = Color(0xFF4A55A2); // Bleu-violet pour titres principaux
  
  static const Color accentColor = Color(0xFF00C48C); // Un vert pour les succès ou accents positifs (non utilisé dans les maquettes mais utile)
  static const Color errorColor = Color(0xFFDE350B); // Rouge pour erreurs et alertes
  static const Color warningColor = Color(0xFFFF8B00); // Orange pour avertissements

  // Couleurs de Texte
  static const Color textPrimary = Color(0xFF1A202C); // Texte principal foncé
  static const Color textSecondary = Color(0xFF4A5568); // Texte secondaire, sous-titres
  static const Color textLight = Color(0xFF718096); // Texte plus clair, placeholders
  static const Color textOnPrimary = Colors.white; // Texte sur fond primaire (boutons)
  static const Color textLink = Color(0xFF6C63FF); // Couleur pour les liens texte

  // Couleurs de Fond
  static const Color backgroundLight = Color(0xFFF7F8FC); // Fond général de l'application
  static const Color backgroundWhite = Colors.white; // Fond pour cartes, modales, etc.
  static const Color backgroundInput = Color(0xFFF7F8FC); // Fond pour les champs de saisie
...
class AppTypography {
  ...
  // Tailles de police
  static const double fontSizeXXSmall = 10.0; // Très petite taille (ex: légendes discrètes)
  static const double fontSizeXSmall = 12.0;  // Petite taille (ex: sous-titres, métadonnées)
  static const double fontSizeSmall = 14.0;   // Taille standard pour le corps du texte
  static const double fontSizeMedium = 16.0;  // Taille pour titres de section, emphase
  ...
  static const double fontSizeXXXLarge = 28.0; // Titres d'application ou de page d'accueil
  ...
  static const TextStyle titleLarge = TextStyle( // Équivalent à .screen-main-title ou .sketch-header
    fontFamily: fontFamily,
  ...
  static const TextStyle titleMedium = TextStyle( // Pour les titres de section
    fontFamily: fontFamily,
  ...
  static const TextStyle titleSmall = TextStyle( // Pour les titres de list-item
    fontFamily: fontFamily,
  ...
  static const TextStyle bodyMedium = TextStyle( // Corps de texte standard
    fontFamily: fontFamily,
  ...
  static const TextStyle bodySmall = TextStyle( // Pour sous-titres de list-item, métadonnées
    fontFamily: fontFamily,
  ...
  static const TextStyle labelLarge = TextStyle( // Pour les boutons
    fontFamily: fontFamily,
  ...
  static const TextStyle labelMedium = TextStyle( // Pour les labels de champs, tags
    fontFamily: fontFamily,
...
class AppSpacings {
  ...
  static const double m = 12.0; // Gap standard dans les maquettes (16px) est un peu grand, ajustons
  static const double l = 16.0; // Padding standard dans sketch-content (20px)
  static const double xl = 20.0;
  static const double xxl = 24.0;
  static const double xxxl = 32.0;
  static const double xxxxl = 40.0; // Gap entre maquettes (50px), padding global (50px)

  // Padding standard pour les écrans
  static const EdgeInsets screenPadding = EdgeInsets.all(l); // 16.0
  static const EdgeInsets screenPaddingHorizontal = EdgeInsets.symmetric(horizontal: l);
  static const EdgeInsets screenPaddingVertical = EdgeInsets.symmetric(vertical: xl); // 20.0
  ...
  static const EdgeInsets buttonPadding = EdgeInsets.symmetric(horizontal: l, vertical: m); // 14px vertical, 20px horizontal
}
...
class AppRadius {
  ...
  static const double rDefault = 10.0; // Pour inputs, boutons (10px dans maquette)
  ...
  static BorderRadiusGeometry get defaultRadius => BorderRadius.circular(rDefault);
...
class AppIcons {
  ...
  static const IconData angleRight = Icons.arrow_forward_ios; // Utilisé pour list-item-action

  // Authentification
  static const IconData email = Icons.email_outlined;
  static const IconData password = Icons.lock_outlined; // ou Icons.visibility_off_outlined
  static const IconData person = Icons.person_outline;
  static const IconData store = Icons.store_mall_directory_outlined; // Pour le logo CommercePro

  // Menu principal / Accueil
  static const IconData home = Icons.home_outlined;
  static const IconData newSale = Icons.point_of_sale_outlined; // ou Icons.add_shopping_cart
  static const IconData products = Icons.inventory_2_outlined; // ou Icons.widgets_outlined
  ...
  static const IconData inventory = Icons.inventory_outlined; // Pour gestion inventaire
  static const IconData suppliers = Icons.local_shipping_outlined; // ou Icons.groups_2_outlined
  
  // Produits & Inventaire
  static const IconData category = Icons.category_outlined; // ou Icons.label_outlined
  static const IconData lowStock = Icons.warning_amber_rounded; // ou Icons.notification_important_outlined
  ...
  static const IconData stockAdjustment = Icons.build_outlined; // ou Icons.tune_outlined
  ...
  static const IconData invoice = Icons.article_outlined; // ou Icons.description_outlined
  static const IconData truck = Icons.local_shipping_outlined; // Pour fournisseurs ou expédition
  static const IconData packageIcon = Icons.inventory_2_outlined; // ou Icons.all_inbox
...
class AppConstants {
  ...
  static const String appVersion = '1.0.0'; // Gérer via build runner si possible
